...
[눈치 코치 캐치!] 는 보이스 채팅과 함께 즐기는 드로잉 게임입니다.

눈치 코치 있게 그림을 캐치하고 센스있게 그림을 그려서 서로의 케미를 맞춰보세요 😉
### 👉🏻 [프론트엔트 바로가기](https://github.com/Trys-Ketch/trys-ketch-client) / [백엔드 바로가기](https://github.com/Trys-Ketch/trys-ketch-server)
<br>
